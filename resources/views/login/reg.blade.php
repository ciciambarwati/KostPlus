...
<body>
  ...
  <div class="login">
        ...
        @csrf
            <input class="form-control" type="text" value="{{ Session::get('name') }}" name="name" placeholder="Enter your name"><br>
            <input class="form-control" type="text" value="{{ Session::get('email') }}" name="email" placeholder="Enter your e-mail"><br>
            <input class="form-control" type="password" name="password" placeholder="Create your password"><br>
            <input class="form-control" type="password" name="password_confirmation" placeholder="Konfirmasi password Kamu"><br>
            <div class="mb-3">
